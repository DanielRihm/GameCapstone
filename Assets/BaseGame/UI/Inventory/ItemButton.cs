...
namespace LCPS.SlipForge.UI
{
    ...
    public class ItemButton : AbstractDisplayButton
    {
        ...
        protected override void Initialize()
        {
            ...
            _activeObservable = DataTracker.GetObservable(data => data.ActiveItem);
        }
        ...
        protected override void OnEnable()
        {
            ...
            _activeObservable.Subscribe(UpdateActiveRef);
        }

        protected void OnDisable()
        {
            _activeObservable.UnSubscribe(UpdateActiveRef);
        }

        // We want the whole observable object so the Equipment screen can null the value and do what we expect
        public void UpdateActiveRef(ActiveData data)
        {
        ...
        protected override void ViewEvent(bool s = true)
        {
            ...
            _equipmentDescription.SetObservable(_activeObservable);
        }
    }
}
